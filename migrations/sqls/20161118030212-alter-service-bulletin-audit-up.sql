DROP TABLE SERVICE_BULLETIN_AUDIT;
DROP SEQUENCE SEQ_SB_AUDIT_ID;
...
ALTER TABLE SERVICE_BULLETIN_AUDIT ADD FOREIGN KEY (SB_ID) REFERENCES SERVICE_BULLETIN (SB_ID);
